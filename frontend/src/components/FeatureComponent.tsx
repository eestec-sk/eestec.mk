...
const FeatureComponent = ({ img, id, heading, subheading } : FeatureProps) => {
    ...
    return(
        <article className="md:grid items-center text-center flex m-3 my-5 p-4 items-center">
            ...
            <div className="m-2 items-center text-center">
                <div className="flex items-center text-center ml-4">
                <h3 className="text-5xl text-eestec font-bold" id={id.toString()}></h3>
